...
public class TestFastDFS {
    ...
    public void testDownload(){
        try {
            ...
            String fileId = "group1/M00/00/00/wKgZhV7Gg_2AGydEAALpqeHvj2g840.jpg";
            byte[] bytes = storageClient1.download_file1(fileId);
            //使用输出流保存文件
            FileOutputStream fileOutputStream = new FileOutputStream(new File("d:/8.jpg"));
